...
Gem::Specification.new do |s|
  ...
  s.summary     = "Includes a Rake task for opening a MongoDB console for the current Rails.env\n\n(keywords: mongo db mongodb database rails rake console)"
  s.description = "Includes a Rake task for opening a MongoDB console for the current Rails.env\n\n(keywords: mongo db mongodb database rails rake console)"
