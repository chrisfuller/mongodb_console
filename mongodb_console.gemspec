...
Gem::Specification.new do |s|
  ...
  s.summary     = "Provides a Rake task for opening a MongoDB console for the current Rails.env\n\n(keywords: mongo db mongodb database rails rake console)"
  s.description = "Provides a Rake task for opening a MongoDB console for the current Rails.env\n\n(keywords: mongo db mongodb database rails rake console)"
