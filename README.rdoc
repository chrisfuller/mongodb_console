...
A gem that includes a Rake task for opening a MongoDB[http://mongodb.org/] console for the current Rails.env

== Prerequisites

Rails must already be configured to use either Mongoid[http://mongoid.org/] or MongoMapper[http://mongomapper.com/].
